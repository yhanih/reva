    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <span className="text-2xl font-bold text-gray-900">Browse Campaigns</span>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="px-4 py-12 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            <p className="text-gray-600 text-lg mb-4">No active campaigns available at the moment.</p>
                ...
                <div className="relative bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
                  ...
                  <div className="space-y-2 mb-4">
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600 text-sm">Payout per click:</span>
                      <span className="text-green-400 font-semibold">${campaign.payout_per_click}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600 text-sm">Budget remaining:</span>
                  ...
                  {campaign.existingLink ? (
                    <div className="space-y-3">
                      <div className="bg-gray-50 rounded-lg p-3 border border-gray-200">
                        <div className="text-xs text-gray-600 mb-1">Your tracking link:</div>
